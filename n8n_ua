...
const Ro = {
  ...
  defaultLanguage: "ua",
  showWelcomeScreen: !1,
  initialMessages: ["Вітаю! 👋 Я – ШІ-консультант у команді VIRSHI", "Ми допомагаємо бізнесам розкрити потенціал штучного інтелекту і стаnи більш продуктивними і життєстійкими. Яке ваше ім'я?"],
  i18n: {
    en: {
